...
# Python packages
export PATH=$PATH:/usr/lib/python3.13/site-packages

# Add Android SDK directories to PATH
...
zle -N clear_screen
bindkey "^[n" clear_screen  # Alt+N alias ohmyzsh="mate ~/.oh-my-zsh"

# Function: try to fg, else open nvim
fg_or_nvim() {
...
[[ -f /home/Adithya/.dart-cli-completion/zsh-config.zsh ]] && . /home/Adithya/.dart-cli-completion/zsh-config.zsh || true
## [/Completion]
